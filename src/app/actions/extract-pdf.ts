...
export async function extractPdfQuestions(formData: FormData) {
    try {
  ...
  "explanation": ""
        ...
        try {
            ...
            return {
                success: false,
                error:
                    "Failed to parse extracted questions. Please try again or check the PDF format.",
            };
        }
        ...
        if (!Array.isArray(questions) || questions.length === 0) {
            return {
                success: false,
                error:
                    "No questions found in the PDF. Please check the document format.",
            };
        }
